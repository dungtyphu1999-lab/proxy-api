...
var upload_dto_1 = require("./upload.dto");
...
var use_jwt_auth_guard_decorator_1 = require("../user/auth/decorators/use-jwt-auth-guard.decorator");
var UploadController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Upload'), (0, common_1.Controller)(), (0, use_jwt_auth_guard_decorator_1.UseJwtAuthGuard)()];
    ...
    var UploadController = _classThis = /** @class */ (function () {
        ...
        UploadController_1.prototype.uploadImage = function (file) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.uploadService.uploadImage(file)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        UploadController_1.prototype.uploadImages = function (files) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.uploadService.uploadImages(files)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _uploadImage_decorators = [(0, common_1.Post)('image'), (0, file_upload_decorators_1.UseImageUpload)('file'), (0, common_1.UsePipes)(new common_1.ValidationPipe({
                transform: true,
                whitelist: true,
                forbidNonWhitelisted: true,
                disableErrorMessages: false,
            })), (0, swagger_1.ApiOperation)({ summary: 'Upload a single image' }), (0, swagger_1.ApiResponse)({
                status: 201,
        ...
        _uploadImages_decorators = [(0, common_1.Post)('images'), (0, common_1.UseInterceptors)((0, platform_express_1.FilesInterceptor)('files', 10, {
                limits: {
                ...
                forbidNonWhitelisted: true,
                disableErrorMessages: false,
            })), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, swagger_1.ApiOperation)({ summary: 'Upload multiple images' }), (0, swagger_1.ApiResponse)({
                status: 201,
            ...
            }), (0, swagger_1.ApiBody)({ type: upload_dto_1.UploadImagesDto })];
