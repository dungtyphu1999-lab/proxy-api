...
var GetUsersDto = function () {
    var _a;
    var _classSuper = pagination_1.ExtendedPaginationQueryDto;
    ...
    return _a = /** @class */ (function (_super) {
            __extends(GetUsersDto, _super);
            function GetUsersDto() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.isLocked = __runInitializers(_this, _isLocked_initializers, void 0);
                _this.isVerified = (__runInitializers(_this, _isLocked_extraInitializers), __runInitializers(_this, _isVerified_initializers, void 0));
        ...
        (function () {
            ...
            _isLocked_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Filter by lock status, 0 hoặc 1' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)([0, 1])];
            _isVerified_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Filter by verification status, 0 hoặc 1',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)([0, 1])];
