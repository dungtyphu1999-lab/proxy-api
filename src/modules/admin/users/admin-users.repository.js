...
var AdminUsersRepository = function () {
    ...
    var AdminUsersRepository = _classThis = /** @class */ (function (_super) {
        __extends(AdminUsersRepository_1, _super);
        function AdminUsersRepository_1() {
        ...
        AdminUsersRepository_1.prototype.findAllUsers = function () {
            return __awaiter(this, arguments, void 0, function (options) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            baseQuery = this.qb
                                .select('users.id', 'users.username', 'users.email', 'users.is_locked', 'users.is_verified', 'users.created_at', 'users.updated_at', 'user_profiles.full_name', 'wallets.balance as wallet_balance', 'wallets.currency as wallet_currency', 'shops.id as shop_id')
                                .leftJoin('user_profiles', 'user_profiles.user_id', 'users.id')
        ...
        AdminUsersRepository_1.prototype.updateUserStatusAndLog = function (userId, isLocked, reason, note, performedBy) {
            return __awaiter(this, void 0, void 0, function () {
                var now, updatedUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.qb.from('user_lock_logs').insert({
                                    user_id: userId,
        ...
        AdminUsersRepository_1.prototype.updateUser = function (id, updates) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AdminUsersRepository_1.prototype.findUserExist = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
