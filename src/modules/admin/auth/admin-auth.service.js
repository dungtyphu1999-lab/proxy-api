...
var AdminAuthService = function () {
    ...
    var _classThis;
    var AdminAuthService = _classThis = /** @class */ (function () {
        function AdminAuthService_1(userService, verificationService, authTokenService, rolesService) {
            this.userService = userService;
            this.verificationService = verificationService;
            this.authTokenService = authTokenService;
            this.rolesService = rolesService;
        }
        AdminAuthService_1.prototype.forgotPassword = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                var user, userRoles, resetCodeSent;
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!userRoles.includes('admin')) {
                                throw new common_1.BadRequestException(error_codes_enum_1.ErrorCode.AUTH_IS_NOT_ADMIN);
                            }
        ...
        AdminAuthService_1.prototype.checkResetCode = function (email, code) {
            return __awaiter(this, void 0, void 0, function () {
                var user, userRoles, isValidCode;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.findByEmail(email)];
                        case 1:
        ...
        AdminAuthService_1.prototype.resetPassword = function (email, code, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var user, userRoles, isValidCode, saltRounds, newPasswordHash;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.findByEmail(email)];
                        case 1:
        ...
        return AdminAuthService_1;
    }());
    __setFunctionName(_classThis, "AdminAuthService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AdminAuthService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AdminAuthService = _classThis;
}();
