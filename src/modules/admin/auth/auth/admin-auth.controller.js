...
var AdminAuthController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('[Admin] Authentication'), (0, common_1.Controller)()];
    ...
    var AdminAuthController = _classThis = /** @class */ (function () {
        function AdminAuthController_1(adminAuthService) {
            this.adminAuthService = (__runInitializers(this, _instanceExtraInitializers), adminAuthService);
        }
        AdminAuthController_1.prototype.forgotPassword = function (forgotPasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminAuthService.forgotPassword(forgotPasswordDto.email)];
                });
            });
        };
        AdminAuthController_1.prototype.verifyResetCode = function (verifyResetCodeDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminAuthService.checkResetCode(verifyResetCodeDto.email, verifyResetCodeDto.code)];
                });
            });
        };
        AdminAuthController_1.prototype.resetPassword = function (resetPasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminAuthService.resetPassword(resetPasswordDto.email, resetPasswordDto.code, resetPasswordDto.new_password)];
                });
            });
        };
        return AdminAuthController_1;
    }());
    __setFunctionName(_classThis, "AdminAuthController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _forgotPassword_decorators = [(0, common_1.Post)('forgot-password'), (0, swagger_1.ApiOperation)({ summary: 'Send password reset code to admin email' }), (0, swagger_1.ApiResponse)({
                status: 200,
        ...
        _resetPassword_decorators = [(0, common_1.Post)('reset-password'), (0, swagger_1.ApiOperation)({ summary: 'Reset admin password using verification code' }), (0, swagger_1.ApiResponse)({
                status: 200,
        ...
        AdminAuthController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AdminAuthController = _classThis;
}();
