...
exports.TestWebshareConnectionDto = void 0;
var class_validator_1 = require("class-validator");
var TestWebshareConnectionDto = function () {
    var _a;
    var _api_key_decorators;
    var _api_key_initializers = [];
    var _api_key_extraInitializers = [];
    return _a = /** @class */ (function () {
            function TestWebshareConnectionDto() {
                this.api_key = __runInitializers(this, _api_key_initializers, void 0);
                __runInitializers(this, _api_key_extraInitializers);
            }
            return TestWebshareConnectionDto;
        }()),
        (function () {
...
exports.TestWebshareConnectionDto = TestWebshareConnectionDto;
