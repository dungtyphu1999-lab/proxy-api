...
exports.CalculateProxyPriceDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var class_transformer_1 = require("class-transformer");
var CalculateProxyPriceDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CalculateProxyPriceDto() {
                ...
                this.quantity_option_id = (__runInitializers(this, _exclusivity_option_id_extraInitializers), __runInitializers(this, _quantity_option_id_initializers, void 0));
                this.bandwidth_option_id = (__runInitializers(this, _quantity_option_id_extraInitializers), __runInitializers(this, _bandwidth_option_id_initializers, void 0));
                this.location_id = (__runInitializers(this, _bandwidth_option_id_extraInitializers), __runInitializers(this, _location_id_initializers, void 0));
                ...
                this.billing_cycle = (__runInitializers(this, _additional_feature_id_extraInitializers), __runInitializers(this, _billing_cycle_initializers, void 0));
                this.discount_percent = (__runInitializers(this, _billing_cycle_extraInitializers), __runInitializers(this, _discount_percent_initializers, void 0));
                this.exclusivity_value = (__runInitializers(this, _discount_percent_extraInitializers), __runInitializers(this, _exclusivity_value_initializers, void 0));
                this.quantity_value = (__runInitializers(this, _exclusivity_value_extraInitializers), __runInitializers(this, _quantity_value_initializers, void 0));
                ...
                this.bandwidth_value = (__runInitializers(this, _proxy_countries_extraInitializers), __runInitializers(this, _bandwidth_value_initializers, void 0));
                __runInitializers(this, _bandwidth_value_extraInitializers);
            }
            return CalculateProxyPriceDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _product_id_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    if (value === null || value === undefined)
                        return value;
                    var num = typeof value === 'string' ? parseInt(value, 10) : Number(value);
                    return isNaN(num) ? value : num;
                }), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(1)];
            ...
            _quantity_option_id_decorators = [(0, swagger_1.ApiPropertyOptional)({
            ...
            _bandwidth_option_id_decorators = [(0, swagger_1.ApiPropertyOptional)({
            ...
            _location_id_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Location ID (currently not affecting price, reserved for future)',
                    example: 1,
            ...
            _additional_feature_id_decorators = [(0, swagger_1.ApiPropertyOptional)({
            ...
            _billing_cycle_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Billing cycle',
                    enum: ['monthly', 'yearly'],
                    example: 'monthly',
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsIn)(['monthly', 'yearly'])];
            _discount_percent_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Discount percent (0-100)',
                    example: 0,
                    default: 0,
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0), (0, class_validator_1.Max)(100), (0, class_transformer_1.Type)(function () { return Number; })];
            _exclusivity_value_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Proxy exclusivity raw value for realtime pricing (shared/private/dedicated)',
                    example: 'shared',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _quantity_value_decorators = [(0, swagger_1.ApiPropertyOptional)({
...
exports.CalculateProxyPriceDto = CalculateProxyPriceDto;
