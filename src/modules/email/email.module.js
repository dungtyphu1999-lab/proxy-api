                    ...
                    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    ...
                                    defaults: {
                                        from: "\"".concat(configService.get('email.fromName'), "\" <").concat(configService.get('email.fromEmail'), ">"),
                                    },
                                    ...
                                    template: {
                                        ...
                                        adapter: new handlebars_adapter_1.HandlebarsAdapter({
                                            ...
                                            formatCurrency: function (amount, currency) {
                                                if (currency === void 0) { currency = 'VND'; }
                                                return new Intl.NumberFormat('vi-VN', {
                                                    style: 'currency',
                                                    currency: currency,
                                                }).format(amount);
                                            },
                                            uppercase: function (str) { return (str ? str.toUpperCase() : ''); },
                                            lowercase: function (str) { return (str ? str.toLowerCase() : ''); },
                                        }),
                                        options: {
                                            strict: true,
                                        },
