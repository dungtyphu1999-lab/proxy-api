...
var username_field_decorator_1 = require("../decorators/username-field.decorator");
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _full_name_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    type: String,
                    maxLength: 100,
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(100)];
            _username_decorators = [(0, username_field_decorator_1.UsernameField)()];
            _phone_number_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Phone number of the user',
                    example: '0901234567',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.ValidateIf)(function (_object, value) { return value !== null && value !== undefined && value !== ''; }), (0, class_validator_1.IsPhoneNumber)('VN', { message: 'Số điện thoại không hợp lệ' })];
