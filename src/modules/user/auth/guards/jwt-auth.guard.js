...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return (0, auth_utils_1.canIgnoreAuth)(this.reflector, context)
                ? true
                : _super.prototype.canActivate.call(this, context);
        };
        JwtAuthGuard_1.prototype.handleRequest = function (err, user, info, context) {
            ...
            if ((0, auth_utils_1.canIgnoreAuth)(this.reflector, context) && (!user || err)) {
                return undefined;
            }
            return _super.prototype.handleRequest.call(this, err, user, info, context);
        };
