...
var ShopsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('[User] Shops'), (0, common_1.Controller)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getUserShop_decorators;
    var ShopsController = _classThis = /** @class */ (function () {
        ...
        ShopsController_1.prototype.getUserShop = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userId = req.user.sub;
                            return [4 /*yield*/, this.shopsService.findShopDetailOfUser(userId)];
    ...
    (function () {
        ...
        _getUserShop_decorators = [(0, common_1.Get)('my-shop'), (0, use_jwt_auth_guard_decorator_1.UseJwtAuthGuard)(), (0, swagger_1.ApiOperation)({
        ...
        __esDecorate(_classThis, null, _getUserShop_decorators, { kind: "method", name: "getUserShop", static: false, private: false, access: { has: function (obj) { return "getUserShop" in obj; }, get: function (obj) { return obj.getUserShop; } }, metadata: _metadata }, null, _instanceExtraInitializers);
