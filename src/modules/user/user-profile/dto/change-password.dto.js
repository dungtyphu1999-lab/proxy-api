...
var validators_1 = require("@/shared/validation/validators");
var ChangePasswordDto = function () {
    ...
    var _confirm_password_decorators;
    var _confirm_password_initializers = [];
    var _confirm_password_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ChangePasswordDto() {
                ...
                this.confirm_password = (__runInitializers(this, _new_password_extraInitializers), __runInitializers(this, _confirm_password_initializers, void 0));
                __runInitializers(this, _confirm_password_extraInitializers);
            }
            return ChangePasswordDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _current_password_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Current password',
                    example: 'currentPassword123',
                }), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _new_password_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'New password (8-20 characters, can contain uppercase, lowercase, numbers and special characters, no spaces)',
                    example: 'MyPassword123!',
                    minLength: 8,
                    maxLength: 20,
                }), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)(), (0, validators_1.IsValidPassword)()];
            ...
            __esDecorate(null, null, _confirm_password_decorators, { kind: "field", name: "confirm_password", static: false, private: false, access: { has: function (obj) { return "confirm_password" in obj; }, get: function (obj) { return obj.confirm_password; }, set: function (obj, value) { obj.confirm_password = value; } }, metadata: _metadata }, _confirm_password_initializers, _confirm_password_extraInitializers);
