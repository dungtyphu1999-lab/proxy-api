...
var UpdateUserProfileDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _full_name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Nguyễn Văn A' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _username_decorators = [(0, swagger_1.ApiProperty)({ example: 'nguyenvana' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.Matches)(/^[a-z0-9_]+$/, {
                    message: 'Username chỉ được chứa chữ thường, số và dấu gạch dưới (_)',
                }), (0, class_validator_1.MinLength)(8), (0, class_validator_1.MaxLength)(30)];
            _phone_number_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: '0909123456' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^\d{10}$/, {
