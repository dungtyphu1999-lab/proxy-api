...
exports.ChangeProxyOrderPasswordDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var ChangeProxyOrderPasswordDto = function () {
    var _a;
    var _new_password_decorators;
    var _new_password_initializers = [];
    var _new_password_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ChangeProxyOrderPasswordDto() {
                this.new_password = __runInitializers(this, _new_password_initializers, void 0);
                __runInitializers(this, _new_password_extraInitializers);
            }
            return ChangeProxyOrderPasswordDto;
        }()),
        (function () {
...
exports.ChangeProxyOrderPasswordDto = ChangeProxyOrderPasswordDto;
