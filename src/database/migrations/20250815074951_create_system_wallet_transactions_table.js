        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, knex.schema.createTable('system_wallet_transactions', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('system_wallet_transactions')];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, knex.raw('DROP TYPE IF EXISTS system_transaction_type')];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, knex.raw('DROP TYPE IF EXISTS transaction_status')];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
