...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.hasTable('history_order_dich_vu')];
                case 1:
                    hasTable = _a.sent();
                    ...
                    if (hasTable)
                        return [2 /*return*/];
                    return [4 /*yield*/, knex.schema.createTable('history_order_dich_vu', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('history_order_dich_vu')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
