...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.raw("CREATE EXTENSION IF NOT EXISTS pgcrypto")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.createTable('telegram_notification_settings', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('telegram_notification_settings')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
