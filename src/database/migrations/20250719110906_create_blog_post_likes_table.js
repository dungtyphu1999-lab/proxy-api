...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.createTable('blog_post_likes', function (table) {
                        ...
                        table.check('(blog_post_id IS NOT NULL AND comment_id IS NULL) OR (blog_post_id IS NULL AND comment_id IS NOT NULL)', { constraintName: 'check_like_target' });
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('blog_post_likes')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
