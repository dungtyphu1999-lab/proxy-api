...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.alterTable('products', function (table) {
                        ...
                        table.index(['total_like', 'total_view', 'total_review'], 'idx_products_engagement_metrics');
                    })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.alterTable('products', function (table) {
                        // Remove indexes
                        table.dropIndex(['total_like', 'total_view', 'total_review'], 'idx_products_engagement_metrics');
