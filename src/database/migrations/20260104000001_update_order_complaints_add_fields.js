    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, knex.raw('DROP INDEX IF EXISTS order_complaints_order_id_index')];
                case 1:
                    // 1. Add UNIQUE constraint on order_id (1 complaint per order)
                    // First drop the existing index
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable('order_complaints', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.alterTable('order_complaints', function (table) {
                        // Drop new columns
