        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, knex.schema.createTable('product_boost_usage_logs', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('product_boost_usage_logs')];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, knex.raw('DROP TYPE IF EXISTS boost_event_type')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
