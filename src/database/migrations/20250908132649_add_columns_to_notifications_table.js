...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.alterTable('notifications', function (table) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Drop index first
                return [4 /*yield*/, knex.schema.raw('DROP INDEX IF EXISTS idx_notifications_related_entity')];
                case 1:
                    // Drop index first
                    _a.sent();
                    // Drop columns
                    return [4 /*yield*/, knex.schema.alterTable('notifications', function (table) {
