...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.hasColumn('proxy_whale_accounts', 'pool_key')];
                case 1:
                    hasPoolKey = _a.sent();
                    if (!!hasPoolKey) return [3 /*break*/, 3];
                    return [4 /*yield*/, knex.schema.alterTable('proxy_whale_accounts', function (table) {
