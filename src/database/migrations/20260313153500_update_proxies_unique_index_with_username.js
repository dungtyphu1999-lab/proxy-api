...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.raw('DROP INDEX IF EXISTS idx_proxies_user_address_port')];
                case 1:
                    _a.sent();
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.raw('DROP INDEX IF EXISTS idx_proxies_user_type_addr_port_user')];
                case 1:
                    _a.sent();
