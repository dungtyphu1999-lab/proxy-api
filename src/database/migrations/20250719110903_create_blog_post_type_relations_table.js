...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.createTable('blog_post_type_relations', function (table) {
                        table
                            .uuid('blog_post_id')
                            .notNullable()
                            .references('id')
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTableIfExists('blog_post_type_relations')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
