...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, knex.schema.createTable('advertisements', function (table) {
                    // Primary key
                    ...
                    // Indexes
                    table.index(['placement', 'is_active', 'display_order'], 'idx_placement_active_order');
                })];
        });
    });
}
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, knex.schema.dropTableIfExists('advertisements')];
        });
    });
}
