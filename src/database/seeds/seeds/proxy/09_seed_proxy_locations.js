...
function seed(knex) {
    return __awaiter(this, void 0, void 0, function () {
        var now, _i, LOCATIONS_1, row, exists;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, knex('proxy_locations')
                            .where('location_key', row.location_key)
                            .update(__assign(__assign({}, row), { updated_at: now }))];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, knex('proxy_locations').insert(__assign(__assign({}, row), { is_active: true, created_at: now, updated_at: now }))];
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6:
