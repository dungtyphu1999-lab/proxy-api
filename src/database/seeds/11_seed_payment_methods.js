...
function seed(knex) {
    return __awaiter(this, void 0, void 0, function () {
        var now, _i, METHODS_1, row, exists;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < METHODS_1.length)) return [3 /*break*/, 7];
                    row = METHODS_1[_i];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, knex('payment_methods').where('code', row.code).update({
                            name_vi: row.name_vi,
                            name_en: row.name_en,
                ...
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, knex('payment_methods').insert(__assign(__assign({}, row), { is_active: true, created_at: now, updated_at: now }))];
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6:
